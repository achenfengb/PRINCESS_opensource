#ifndef TDT_ENCLAVE_T_H__
#define TDT_ENCLAVE_T_H__
...
void freeBC();
void updateBC_wraper(sgx_ra_context_t context, char* data, int size_in, int numberofParties, int topK, int compression, int client, int size_after_decompression);
void load_cm(sgx_ra_context_t context, char* cm, int size_in, int client_num);
void result_encryption(char* result, int size_out, sgx_ra_context_t* context, int size_context, int numberofParties, int topK);
