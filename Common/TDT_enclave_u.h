...
sgx_status_t updateBC_wraper(sgx_enclave_id_t eid, sgx_ra_context_t context, char* data, int size_in, int numberofParties, int topK, int compression, int client, int size_after_decompression);
